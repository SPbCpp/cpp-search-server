...
//
//Сделайте то же самое не с конкретным тестовым запросом, а с результатом
//вызова функции ReadSearchQuery. Добавьте её в свой код:
// 
...
int main()
{
    string query = ReadSearchQuery();// ваш код
