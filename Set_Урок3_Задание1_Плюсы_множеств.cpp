...
//Есть слова запроса и описание животного.Посчитайте релевантность
//запроса — размер множества слов, которые входят и в запрос, и в описание.
//Формат ввода
