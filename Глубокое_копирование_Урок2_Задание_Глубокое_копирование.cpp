...
//Задание
//
//Посмотрите на код, разбивающий текст на слова с учётом стоп - слов.
//Избавьтесь от лишних копирований в заголовках функций и в циклах for.
//Для этого допишите к типам амперсанды в нужных участках кода.
