//Map
//
//Урок 5. Словари и константность
//
//Задание
//
//Вернитесь к алгоритму поиска, который обсуждался в начале урока, и который
//так и не был закончен из-за размышлений о подходящем контейнере.
//Возьмите слово из списка поиска и проверьте, что это не стоп - слово.
//Если это не стоп-слово, найдите информацию о том, в каких документах
//оно встречается. Вы уже знаете, что это будет множество из ID.
...
//Верните результат поиска без повторов.Не меняйте сигнатуру FindDocuments.
// 
